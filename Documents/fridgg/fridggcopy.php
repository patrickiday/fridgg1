...
<html>
	...
	<body>
		...
		<div class="maincontent cls">
			...
			$userpost[1] = new Post();
			$userpost[1]->id = 28946;
			$userpost[1]->photo = 'pankopotatoe.png';
			$userpost[1]->logo = 'userlogo.png';
			$userpost[1]->title = 'Spicy Panko Crusted Potato Cakes';
			$userpost[1]->linkname = 'ohmydish';
			$userpost[1]->username = 'ohmydish';

			$userpost[2] = new Post();
			$userpost[2]->id = 30348;
			$userpost[2]->photo = 'smokeybbqbeans.png';
			$userpost[2]->logo = 'uservanillabean.png';
			$userpost[2]->title = 'Smokey BBQ Baked Beans';
			$userpost[2]->linkname = 'vanillaandbean';
			$userpost[2]->username = 'Vanilla And Bean';

			$userpost[3] = new Post();
			$userpost[3]->id = 30303;
			$userpost[3]->photo = 'strawberryrhubarb.png';
			$userpost[3]->logo = 'userallison.png';
			$userpost[3]->title = 'Strawberry Rhubarb Crumble Bars';
			$userpost[3]->linkname = 'allisonday';
			$userpost[3]->username = 'Allison Day';

			$userpost[4] = new Post();
			$userpost[4]->id = 30124;
			$userpost[4]->photo = 'surimistirfry.png';
			$userpost[4]->logo = 'userohmydish.png';
			$userpost[4]->title = 'Surimi stir fry';
			$userpost[4]->linkname = 'ohmydish';
			$userpost[4]->username = 'ohmydish';


			$posts = array( $userpost[1], $userpost[2], $userpost[3], $userpost[4]);
